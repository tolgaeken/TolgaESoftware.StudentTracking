...
{
    public class PaymentDocumentsReportBll : BaseActionBll<PaymentInformations, StudentTrackingContext>
    {
        public IEnumerable<PaymentDocumentsReportList> List(Expression<Func<PaymentInformations, bool>> filter, IEnumerable<DocumentStatus> documentStatuses)
        {
            ...
            }).Select(p => new PaymentDocumentsReportList
            {
                AccrueId = p.Payment.AccrueId,
