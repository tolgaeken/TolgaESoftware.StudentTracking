namespace TolgaESoftware.StudentTracking.UI.Win.Forms.ForeignLanguageForms
{
    partial class ForeignLanguageListForm
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ForeignLanguageListForm));
            ...
            this.colForeignLanguageName = new TolgaESoftware.StudentTracking.UI.Win.UserControls.Grids.MyGridColumn();
            ...
            this.table.ViewCaption = "Yabancı Dil Kartları";
            // 
            // colId
            // 
            ...
            this.colForeignLanguageName.OptionsColumn.AllowFocus = false;
