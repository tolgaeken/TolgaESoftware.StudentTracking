...
{
    public partial class PriceAndPaymentReport : BaseReport
    {
        public PriceAndPaymentReport()
        {
            InitializeComponent();
        }
        protected override void FillVariables()
        {
            ...
            LoadCancelStatuses();
            ReportType = CardType.PriceAndPaymentReport;
        }
        ...
        protected override void List()
        {
            ...
            using (var bll = new PriceAndPaymentReportBll())
            {
        ...
        {
            var entity = table.GetRow<PriceAndPaymentReportList>();
