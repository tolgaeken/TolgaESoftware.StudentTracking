...
{
    public partial class VocationalGroupReport : BaseReport
    {
        public VocationalGroupReport()
        {
            InitializeComponent();
        ...
        protected override void FillVariables()
        {
            ...
            LoadCancelStatuses();
            ReportType = CardType.VocationalGroupReport;
        }
        ...
        protected override void List()
        {
            ...
            using (var bll = new VocationalGroupReportBll())
            {
